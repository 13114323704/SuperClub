...
public class SearchMapActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        bdMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                View view = LayoutInflater.from(SearchMapActivity.this)
                        .inflate(R.layout.popup_marker_layout, null);
                final LatLng ll = marker.getPosition();

                InfoWindow mInfoWindow = new InfoWindow(view, ll, -50);
                bdMap.showInfoWindow(mInfoWindow);
                final TextView textView2=view.findViewById(R.id.text_marker_content);

                //将marker代表的经纬度转化为详细地址信息
                ...
                geoCoder.setOnGetGeoCodeResultListener(new OnGetGeoCoderResultListener() {
                    ...
                    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
                        ...
                        Log.i("Main","latitude--->>>>"+ll.latitude);
                        Log.i("Main","longitude--->>>>"+ll.longitude);
                    }
                });

                view.findViewById(R.id.image_marker_close).setOnClickListener(new View.OnClickListener() {
                    @Override
        ...
        newLatLng=new LatLng(30.612568352717744,114.32292257196524);
        ...
        OverlayOptions options = new MarkerOptions().icon(icon).position(newLatLng);
    ...
    public void searchButtonProcess(View v) {
        String city_string = editCityEt.getText().toString();
    ...
    class getData extends AsyncTask<String, String, String> {
        ...
        String text_city = editCityEt.getText().toString();
