...
public class MineHonorActivity extends AppCompatActivity {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MineHonorActivity.this, "刷新成功！", Toast.LENGTH_SHORT).show();
                    }
                }, 2000);
            }
        });
